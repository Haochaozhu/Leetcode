 ...
 * increase its capital before the IPO. Since it has limited resources,
...
public class IPO {
    public int findMaximizedCapital(int k, int W, int[] Profits, int[] Capital) {
        PriorityQueue<int[]> projects = new PriorityQueue<>((o1, o2) -> o1[1] - o2[1]);
        ...
        while (k > 0) {
            while (!projects.isEmpty() && projects.peek()[1] <= W) {
                available.offer(projects.poll()[0]);
            }
