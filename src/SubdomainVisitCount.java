 ...
 * of various subdomains. At the top level, we have "com",
...
public class SubdomainVisitCount {
    public List<String> subdomainVisits(String[] cpdomains) {
        ...
        for (String domains : cpdomains) {
            String[] twoparts = domains.split("\\s+");
            String[] subDomains = twoparts[1].split("\\.");
            String cur = "";
            int count = Integer.valueOf(twoparts[0]);
